#  Credit to https://github.com/noahgolmant/pytorch-lars/blob/master/lars.py
...
class LARS(Optimizer):
    ...
    Example:
        ...
        >>> optimizer.step()
    """
    def __init__(self, params, lr, momentum=config.MOMENTUM,
                 weight_decay=config.WEIGHT_DECAY, eta=0.001, max_epoch=200):
        if lr < 0.0:
